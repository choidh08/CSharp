...
{
    public class ResponseTradingCoinAutoTradeSelModel : ResponseBaseModel
    {
        public ResponseTradingCoinAutoTradeSelDataModel data { get; set; }
        public ResponseTradingCoinAutoTradeSelModel()
        {
            data = new ResponseTradingCoinAutoTradeSelDataModel();
        }
    }

    public class ResponseTradingCoinAutoTradeSelDataModel
    {
        /// <summary>
        /// 등록시간
        /// </summary>
